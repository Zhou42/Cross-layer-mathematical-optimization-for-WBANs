...
plt.plot(f, energyDict['energyConsumption_Multihop_FixedRelayLocation'][0], label="Multi-hop network with fixed relay location",color="black", marker='o', linestyle="-", fillstyle='none')
