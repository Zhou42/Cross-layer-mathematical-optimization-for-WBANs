...
%% Given the optimal lambda and optimal z, solve (11)
% superframe 400ms, 100kbps
load('../Results_20kbps_400ms_binarysearch_decomposition.mat','z','lambda');
% load('Primal_Results_10kbps_400ms.mat','z_opt');
[ t_tilde_opt, P_tilde_opt, T_tilde_opt, optimalValue ] = SolutionOf11_GivenLambdaAndZ(lambda, find(z == 1));
sum(exp(T_tilde_opt(1:S_num))) + sum(exp(T_tilde_opt(find(z == 1)))) - T_frame
